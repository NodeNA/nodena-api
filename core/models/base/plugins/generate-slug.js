...
import { string } from "@tryghost/security";

import { getProtectedSlugs } from "../../../../shared/url-utils";
    ...
    {},
    {
      ...
      generateSlug: function generateSlug(Model, base, options) {
        ...
        if (slug.length > 185) {
          ...
          if (!has(options, "importing") || !options.importing) {
        ...
        slug = includes(getProtectedSlugs(), slug)
          ? slug + "-" + baseName
          : slug;
